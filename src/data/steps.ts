...
export const steps: Step[] = [
  {
    ...
    description: '',
    isOptional: true,
    actions: ['Apply 10+ minutes before washing (1-2x per week).'],
    timerMinutes: 10,
  ...
  },
  {
    ...
    description: '',
    isOptional: true,
    actions: ['Apply 20+ minutes before washing. Skip on days using post-shampoo bond repair treatments.'],
    timerMinutes: 20,
  ...
  },
  {
    ...
    description: 'Your regular, everyday shampoo. Gentler formulas with bond-repairing or strengthening ingredients.',
    isOptional: false,
  ...
  },
  {
    ...
    description: 'Repairs and strengthens hair bonds after cleansing. Helps restore damaged hair structure.',
    isOptional: true,
  ...
  },
  {
    ...
    description: 'Addresses scalp issues like dandruff, itching, irritation, or flaking.',
    isOptional: true,
  ...
  },
  {
    id: 7,
    title: 'Conditioning',
    description: 'Step 7 is broken into three parts—glosses, conditioners, and hair masks—giving you flexibility to mix and match based on your hair\'s needs.',
    isOptional: false,
  ...
  },
  {
    ...
    description: 'Ongoing hydration and heat protection for styling. These products serve double duty as both leave-in conditioners and heat protectants.',
    isOptional: false,
  ...
  },
  {
    id: 9,
    title: 'Styling',
    description: 'Optional. Use any styling products in whatever order works best for your routine.',
    isOptional: true,
  ...
  },
  {
    id: 10,
    title: 'Style Sealers',
    description: 'Finishing touch for additional conditioning, softening, smoothing, and shine. Choose serum, lotion, cream, or oil based on your hair\'s needs.',
    isOptional: true,
  ...
  },
  {
    ...
    description: 'Maintain your hair between wash days. Choose conditioning, heat protection, or dry shampoo based on your hair\'s needs.',
    isOptional: true,
