...
export const steps: Step[] = [
  {
    ...
    description: '',
    isOptional: true,
    actions: ['Apply at least 10 minutes before washing or applying any other product (1-2x per week).'],
    timerMinutes: 10,
    products: ['ePres Bond Repair Treatment'],
    notes: 'Optional if using other bond repair treatments.',
  },
  {
    id: 2,
    ...
    description: '',
    isOptional: true,
    actions: ['For damaged hair prone to dryness and tangling, you can apply a pre-shampoo oil treatment at least 20 minutes before washing (skip on days you are using post-shampoo bond repair treatments).'],
    timerMinutes: 20,
    products: ['OGX Extra Strength Coconut Miracle Oil Penetrating Oil'],
  },
  {
    id: 3,
    ...
    description: '',
    isOptional: true,
    actions: ['Use at least once a week, or more if needed.'],
